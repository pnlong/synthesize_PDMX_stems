...
The Chamber Ensemble Generator~\cite{wu2022chamber} uses MIDI-DDSP to synthesize large-scale chamber-ensemble audio for MIR, pairing generated scores with neural renders.
We treat MIDI-DDSP as one optional render path in a broader factorial design (PDMX-scale GM families, with soundfont fallbacks) rather than a single end-to-end synthesizer.
